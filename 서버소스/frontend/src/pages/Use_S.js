    ...
    return (
        <div className='mobile'>
            ...
            <div style={{fontSize:"20px"}}>
                ...
                <button type="button" className='greenButton' onClick={() => navigate('/Use_S2')} style={{width:"100%", height:"80px", fontSize:"20pt", marginTop:"10px"}}>다음</button>
            </div>
        </div>
   );
};

export default Use_S;
