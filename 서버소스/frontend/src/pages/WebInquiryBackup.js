...
const WebInquiry = () => {
    ...
    const PAGE_SIZE = 1; // 페이지 당 표시할 항목 수
            ...
            <Menu />
                <div className='contents' style={{position:"relative", bottom:"30px"}}>
                    ...
                    <div className='flex'>
                        ...
                        <div className='greyBox' style={{marginRight:"20px", width:"730px"}}>문의 제목</div>
                    </div>
                    <div>
                         <ul style={{listStyleType: "none", fontSize: "20px", width: "85%", maxHeight: "650px", overflowY: "auto", margin:"auto"}}>
                            ...
                            <li key={result.inquiry_ID}>
                                <div className="linkBorder" to={``}
                                    ...
                                    <div className="userContent" style={{width:"700px"}}>{result.subject}</div>
                                </div>
                                ...
                                <button type="button" className='darkButton' onClick={() => handleAnswer(result.inquiry_ID)} style={{width:"200px", height:"70px", fontSize:"30px", marginTop:"10px", marginRight:"30px"}}>문의 답변</button>
                            </li>
                            ))}
                        </ul>
                    <div>
