...
function AI() {
    ...
    */
    ...
    const saveMyFlower2 = async (plantdata_ID, photo_ID, user_ID, humidity, light_demand, temperature, watering) => {
        try {
            // 서버에 보낼 객체
            const data = {
                user_ID: user_ID,
    ...
    <div className='mobile'>
        ...
        <div className='body2'>
            ...
            {plantDetails ? (
                ...
                onClick={() => {
                    saveMyFlower2({ plantdata_ID: plantDetails.plantdata_ID, photo_ID: latestResult.latestResult.photo_ID, user_ID: userId.Id, humidity: plantDetails.humidity, light_demand: plantDetails.light_demand, temperature: plantDetails.temperature, watering: plantDetails.watering});
                    sendFlowerNameToFlutter(plantDetails.name + ',' + userId.Id);
                }}
                style={{ width: "50%", height: "80px", fontSize: "20pt"}}>식물 등록</button>
